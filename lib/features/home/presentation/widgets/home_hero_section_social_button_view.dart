...
class HomeHeroSectionSocialButtonView extends StatelessWidget {
    ...
    return Column(
      ...
      children: [
        Row(
          children: [
            Container(
              width: context.isDesktop ? 100 : 20,
              height: 1,
            ...
            const SocialLinksWidget(isPrimary: false),
          ],
        ),
        SizedBox(height: context.isDesktop ? 40 : 20),
  ...
  Widget _buildSocialButton(BuildContext context) {
    return Consumer<ScrollControllerProvider>(builder: (context, provider, child) {
      return Row(
        spacing: context.isDesktop ? 10 : 4,
        children: [
          UnderLineButton(
            title: 'Let\'s Talk',
            onPressed: () => provider.scrollToIndex(appBarPages.length - 1),
          ),
          Container(
            width: context.isDesktop ? 30 : 10,
            height: 1,
            decoration: BoxDecoration(
              color: context.primaryTextColor,
              borderRadius: BorderRadius.circular(10),
